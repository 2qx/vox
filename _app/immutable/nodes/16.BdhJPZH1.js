...
// }
//}`}},w=["BCH_2022_05","BCH_2023_05","BCH_2024_05","BCH_2025_05","BCH_SPEC"],X={$schema:D,description:L,name:S,entities:V,scenarios:H,scripts:q,supported:w},Y="@unspent/trust",F={name:Y},M=4383,j=989995,Q=1e6;class ${static USER_AGENT=F.name;static template=X;static compiler=y(this.template);static getLockingBytecode(t={}){const e=this.compiler.generateBytecode({data:t,scriptId:"lock"});if(!e.success)throw new Error("Failed to generate bytecode, script: , "+h(e));return e.bytecode}static getScriptHash(t=!0){return k(this.getLockingBytecode(),t)}static getAddress(t="bitcoincash"){return U(this.getLockingBytecode(),t)}static getOutput(t){let e=Math.round(t.value*j/Q)-1;return{lockingBytecode:{compiler:this.compiler,script:"lock"},valueSatoshis:BigInt(e)}}static getInput(t){return{outpointIndex:t.tx_pos,outpointTransactionHash:B(t.tx_hash),sequenceNumber:M,unlockingBytecode:{compiler:this.compiler,script:"unlock",valueSatoshis:BigInt(t.value)}}}static processOutpoint(t){const e=[],n=[];n.push(this.getOutput(t)),e.push(this.getInput(t));const s=x({locktime:0,version:2,inputs:e,outputs:n});if(!s.success)throw new Error("generate transaction failed!, errors: "+h(s.errors));return b(N(s.transaction))}}var G=r('<img alt="Disconnected"/>'),z=r('<section><div class="status svelte-1jejjaq"><!> <!></div> <!></section>');function at(o,t){O(t,!0);var e=z(),n=p(e),i=p(n);v(i,{get template(){return $.template}});var s=l(i,2);{var m=a=>{var u=G();E(()=>f(u,"src",T)),c(a,u)};I(s,a=>{a(m,!1)})}d(n);var _=l(n,2);C(_),d(e),c(o,e),P()}export{at as component,it as universal};
//# sourceMappingURL=16.BdhJPZH1.js.map
